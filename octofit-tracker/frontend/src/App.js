          ...
          <Route path="/" element={
            <div className="card mt-4">
              <div className="card-body">
                <h2 className="card-title h3">Welcome to Octofit Tracker!</h2>
                <p className="card-text">Track your fitness activities, join teams, compete on the leaderboard, and more!</p>
